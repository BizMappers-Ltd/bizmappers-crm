        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="w-75 mx-auto my-5 p-5 border rounded bg-white shadow-lg">
                ...
                <form method="POST" action="{{ route('employee.update', $employee->id) }}" class="my-3 login-input">
                    ...
                    <div class="">
                        ...
                        <input value="{{ $employee->email }}" id="email" class="form-control rounded" type="email" name="email" placeholder="employee Email" required />
                    </div>

                    <div class="d-flex justify-content-end mt-4">
                        <input type="submit" name="submit" value="Update Employee" class="btn btn-sm btn-primary">
                    </div>
                </form>
            </div>
            <!-- #/ container -->
