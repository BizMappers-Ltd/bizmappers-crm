            ...
            <div class="w-75 mx-auto my-5 p-5 border rounded bg-white shadow-lg">
                ...
                <form method="POST" action="{{ route('manager.update', $manager->id) }}" class="my-3 login-input">
                    ...
                    <div class="">
                        ...
                        <input value="{{ $manager->username }}" class="form-control rounded" type="text" name="username" placeholder="manager Name" required />
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <input type="submit" name="submit" value="Update Manager" class="btn btn-sm btn-primary">
                    </div>
                </form>
            </div>
            <!-- #/ container -->
